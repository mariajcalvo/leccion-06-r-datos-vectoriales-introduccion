...
Se realiza con las funciones ```st_read()``` y ```st_write()```:
```{r}
...
# Mapa de casos confirmados de COVID-19
plot(cr_cantones_covid19["confirmados"], main="Casos confirmados de COVID-19 en los cantones de Costa Rica", ylab="Cantidad de casos")
```
