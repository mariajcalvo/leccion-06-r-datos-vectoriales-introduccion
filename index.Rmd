...
En el ejemplo anterior, se desplegó un mapa por cada variable (i.e. cada columna). ```plot()``` permite también desplegar el mapa correspondiente a una columna particular:
```{r}
